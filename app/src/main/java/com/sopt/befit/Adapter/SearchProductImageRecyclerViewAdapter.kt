...
class SearchProductImageRecyclerViewAdapter(val ctx: Context, val dataList: ArrayList<String>) : RecyclerView.Adapter<SearchProductImageRecyclerViewAdapter.Holder>() {
